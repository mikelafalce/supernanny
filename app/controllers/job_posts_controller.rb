class JobPostsController < ApplicationController
  before_action :authenticate_admin!, :set_job_post, only: [:show, :edit, :update, :destroy]
  ...
  private
    ...
    def job_post_params
      params.require(:job_post).permit(:family_name, :headline, :location, :work_type, :hiring_date, :description)
    end
end
